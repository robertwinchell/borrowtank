...
MEPSTEMP.namespace("UI.DashboardError.Search");
MEPSTEMP.UI.DashboardError.Search = (function () {
	"use strict";
	...
	function BindEvents() {
	    ...
	    MEPSTEMP.Global.ApplyMenuSelection('DashboardError');
	    BindGridEvents();
	...
	function BindGridEvents() {
	    MEPSTEMP.Global.BindDeletionModal(MEPSTEMP.UI.DashboardError.Search.resetGrid);	    	   
		...
		MEPSTEMP.Global.LoadAJAXPagination(
           ...
           //pagination window end page number - default is 3 -carefull : if this is set more than total pages then unwanted behaviour may appear
            ...
            'DashboardErrorSearch/FilterErrorAlertsSearch',
             // success call back
            function (result) {
	...
	function BindCorrectiveActionInProgressPartailView() {
	    ...
	    $('#btnCorrActionInProgressSave').click(function (e) {
	        ...
	        var errorCount = 0;
	        $('#corrActBeingTakenModal').find('.text-danger').each(function () {
	            errorCount += 1;
	        });
	        if (errorCount == 0) {
	            var model = {};
	...
	function SearchDashboardError() {
	    ...
	    var url = 'DashboardErrorSearch/FilterErrorAlertsSearch';
