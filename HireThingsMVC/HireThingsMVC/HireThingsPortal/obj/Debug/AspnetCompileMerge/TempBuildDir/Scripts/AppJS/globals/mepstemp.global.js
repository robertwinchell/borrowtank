...
MEPSTEMP.namespace("Global");
MEPSTEMP.Global = (function () {
    "use strict";
    var counter = 0;
    ...
    function GenerateValidationMessage(name) {
        ...
        var elIdent = '';
        if ($.trim(name.toLowerCase()) == 'ddlorganization') {
            elIdent = 'Organization is ';
        }
        else if ($.trim(name.toLowerCase()) == 'ddlworkstation') {
            elIdent = 'Workstation is ';
        }
    ...
    return {
            ...
            $('.pagel').each(function () {
                ...
                $this.click(function () {
                    ...
                    if ($this.data('target') > 0) {
                        ...
                        if (MEPSTEMP.Global.getParameterByName('p') != '') {
                        ...
                        var p = parseInt(MEPSTEMP.Global.getParameterByName('p'));
        ...
        BindDropDownOnClick: function (type, url, dropdownFirst, dropdownSecond, successCallback) {
            MEPSTEMP.Global.MakeAjaxCall(type, url, {}, function (result) {
                if (successCallback)
                    successCallback(result);
                
                // Success call back from ajax
            }, function (xhr, ajaxOptions, thrownError) {                
                console.log('an error occurred in making ajax call --  MEPSTEMP.Global.BindDropDownOnClick()');
            });
        },
        ...
        KeyLocking: function (className,dataAttr) {
            $(className).each(function () {
                $(this).keydown(function (e) {
                    console.log('key locking');
                    MEPSTEMP.Utilities.getRegularExp($(this).attr(dataAttr),e,this);                  
                });
        ...
        BindDeletionModal: function (functionToExecute) {
            ...
            $('.btnItemDelete').each(function () {
                ...
                $(this).click(function () {                    
                    ...
                    MEPSTEMP.Global.MakeAjaxCall("GET", url, data, function (result) {
                        ...
                        $('#btnDeleteConfirm').click(function () {
                            ...
                            var objectName = window.location.href.substring(0, window.location.href.lastIndexOf('/'));
                            ...
                            MEPSTEMP.Global.MakeAjaxCall("POST", 'ItemDelete/Index', dataPost, function (result) {
                                
                                $('#confirm-delete').modal('hide');
                                if (result == 'True') {
                                    
                                    $('#errorDiv').html('<div class="row FadeOut mb-sm"><div class="col-lg-12"><div class="alert alert-success mb-sm"><p class="m-none text-semibold h6">Success : Record Has Been Deleted Successfully.</p></div></div></div>');
                                    functionToExecute();
