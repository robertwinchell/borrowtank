...
MEPSTEMP.namespace("UI.ProbeManf.Search");
MEPSTEMP.UI.ProbeManf.Search = (function () {
    "use strict";
    var _isInitialized = false;

    var $ddlSearch, $txtSearch, $ddlDeviceGroup, $ddlSystem, $ddlGroup, $DivProbeManfGrid, $btnProbeManfSearch;
    ...
    function CacheEl() {
        $txtSearch = $('#txtSearch');
        $DivProbeManfGrid = $('#DivProbeManfGrid');
        $btnProbeManfSearch = $('#btnProbeManfSearch');
    }
    //Event binding done in here
    function BindEvents() {
        MEPSTEMP.Global.ApplyMenuSelection('ProbeManufacturer');
        BindGridEvents();
        //Search button event
        ...
        $btnProbeManfSearch.click(function () {
            SearchProbeManf();
        });
    ...
    function BindGridEvents() {
        MEPSTEMP.Global.BindDeletionModal(MEPSTEMP.UI.ProbeManf.Search.resetGrid);
        $('.btnProbeManfEdit').each(function () {
            $(this).click(function () {
                $('#hdProbeManfId').val($(this).data('probemnfid'));
              
                $('#ProbeManfSearch').submit();
            });
        });
        ...
        MEPSTEMP.Global.LoadAJAXPagination(
           ...
           //pagination window end page number - default is 3 -carefull : if this is set more than total pages then unwanted behaviour may appear
            ...
            'ProbeManufacturerSearch/FilterProbeManfSearch',
             // success call back
            function (result) {
                $DivProbeManfGrid.html(result);
    ...
    function SearchProbeManf() {

        var url = 'ProbeManufacturerSearch/FilterProbeManfSearch';
