...
MEPSTEMP.namespace("UI.DashboardError.CorrActionInProgress");
MEPSTEMP.UI.DashboardError.CorrActionInProgress = (function () {
	"use strict";
	...
	function BindEvents() {
	    ...
	    MEPSTEMP.Global.ApplyMenuSelection('CorrActionInProgress');
	    BindGridEvents();
	...
	function BindGridEvents() {
		...
		MEPSTEMP.Global.LoadAJAXPagination(
           ...
           //pagination window end page number - default is 3 -carefull : if this is set more than total pages then unwanted behaviour may appear
            ...
            'DashboardErrorSearch/FilterCorrActionInProgressSearch',
             // success call back
            function (result) {
	...
	function SearchDashboardError() {
	    ...
	    var url = 'DashboardErrorSearch/FilterCorrActionInProgressSearch';
