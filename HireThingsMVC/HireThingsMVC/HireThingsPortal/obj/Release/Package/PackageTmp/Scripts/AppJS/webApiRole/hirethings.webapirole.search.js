...
HIRETHINGS.namespace("UI.WebApiRole.Search");
HIRETHINGS.UI.WebApiRole.Search = (function () {
    "use strict";
    ...
    function CacheEl() {
        ...
        $btnRoleSearch = $('#btnWARoleSearch');
    }
    //Event binding done in here
    function BindEvents() {
        HIRETHINGS.Global.ApplyMenuSelection('webapirole');
    ...
    function BindGridEvents() {
        HIRETHINGS.Global.BindDeletionModal(HIRETHINGS.UI.WebApiRole.Search.resetGrid);
        $('.btnWARoleEdit').each(function () {
            $(this).click(function () {
                $('#hdWARoleId').val($(this).data('roleid'));
                $('#WARoleSearch').submit();
            });
        });
        ...
        HIRETHINGS.Global.LoadAJAXPagination(
           ...
           //pagination window end page number - default is 3 -carefull : if this is set more than total pages then unwanted behaviour may appear
            ...
            'WebApiRoleSearch/FilterRoleSearch',
             // success call back
            function (result) {
    ...
    function SearchRole() {
        ...
        var url = 'WebApiRoleSearch/FilterRoleSearch';
