...
HIRETHINGS.namespace("UI.SecurityQuestion.Search");
HIRETHINGS.UI.SecurityQuestion.Search = (function () {
    "use strict";
    ...
    function BindEvents() {
        HIRETHINGS.Global.ApplyMenuSelection('SecurityQuestion');
        BindGridEvents();
        //Search button event
    ...
    function BindGridEvents() {
        HIRETHINGS.Global.BindDeletionModal(HIRETHINGS.UI.SecurityQuestion.Search.resetGrid);
