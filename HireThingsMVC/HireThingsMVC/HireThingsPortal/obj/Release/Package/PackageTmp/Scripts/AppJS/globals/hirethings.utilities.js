...
HIRETHINGS.namespace("Utilities");
HIRETHINGS.Utilities = (function () {
    "use strict";
    ...
    function globalAllowedKeys(type, e, control) {
        ...
        if (type == 'specialalphabet') {
            ...
            arr = [46, 64, 16,50,173,8, 9, 27, 13, 144, 57, 48, 190, 109, 188, 189];
        ...
        getRegularExp: function (identifier, e, control) {
            switch ($.trim(identifier.toLowerCase())) {
                ...
                case 'ipaddress':
                    ...
                    break;
                case 'email':
                   if (globalAllowedKeys('email', e, control) || (NumericAllowedKeys(e) || AlphabetAllowedKeys(e))) {
                    }
                    else {
                        e.preventDefault();
                    }
